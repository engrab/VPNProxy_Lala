package com.lalaapps.vpnproxyapp.securevpn.fastconnection.stableconnection.pojoClasses;
...
public class ServerModel implements Parcelable {
    ...
    public ServerModel(String hostName, String ipAddress, String ping, long speed, String countryLong, String countryShort, String ovpnConfigData, int port, String protocol) {
